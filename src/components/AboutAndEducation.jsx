...
const AboutAndEducation = () => {
    return (
        <div id='aboutAndEducation' className='bg-bluee text-white px-16 pb-16'>
            ...
            <div className="relative flex items-center gap-2  pt-14">
                ...
                <div className="absolute -left-10 top-0 opacity-5 text-[4.5rem] font-bold tracking-wider">About & Education</div>
            </div>
                    ...
                    <div className='flex flex-col gap-3 pt-3'>
                        <div className='w-full bg-background bg-opacity-10  rounded-xl px-5 py-2 flex items-center justify-between'>
                            <div className='py-1.5'>
                                <h1 className='font-bold text-gray-950'>B.Tech in Electronics and Communication Engineering</h1>
