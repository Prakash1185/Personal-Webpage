...
const PlayGamesCTA = () => {
    return (
        <div id="quote" className="bg-bluee text-white  py-8   md:px-16 px-10  sm:px-14 md:pb-20 pb-10">
            ...
            <div className="relative flex items-center gap-2  pt-14">
                ...
                <div className="absolute -left-10 top-0 opacity-5 text-[3.5rem] md:text-[4.5rem] font-bold tracking-wider">Play Games</div>
            </div>

            <div className="pt-5 flex items-center justify-between flex-col md:flex-row gap-5">
                <p className="text-5xl font-medium pb-6 md:pb-0 tracking-wide">Explore some fun activities and enjoy</p>
                ...
                >
                    <a href="#activities">Explore Now</a>
                    <svg
                        className="w-8 h-8 justify-end group-hover:rotate-90 group-hover:bg-bluee text-gray-20 0 ease-linear duration-300 rounded-full group-hover:border-none border border-gray-700  p-2 rotate-45"
                        viewBox="0 0 16 19"
