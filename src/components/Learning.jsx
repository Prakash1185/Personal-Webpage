    ...
    return (
        <div id='learning' className='px-10 sm:px-14 md:px-16 pb-16 pt-10 bg-bluee text-white  '>
            ...
            <div className='flex flex-col pt-10 gap-10'>
                ...
                <LearningBox image={mern} title={"Making Full Stack Projects"} descp={"Currently i am making full stack project in mern and i want to learn more about how a website work, how a backend of website is made and works. these are the reasons i am learning mern stack and making full stack projects."} />
